...
class PartNormalDataset(Dataset):
    def __init__(self,root = './data/coating_seam_dataset', npoints=2500, class_choice=None, normal_channel=False,path='/home/lin/CV_AI_learning/Pointnet_book_seam/test/1.txt'):
...
if __name__ =='__main__':
    ...
    img_root = r'./data/coating_seam_dataset' # 数据集路径
    target_root = r'./results/444' # 输出结果路径

    path='data/coating_seam_dataset/12345678/50.txt'
